...
```{r inputq}
gse184410<-getGEO('GSE184410',GSEMatrix=FALSE)
```
...
Next let's merge the 2 files with sample annotation information. From the GSE dataset let's save the following variables: geo_assession, 'cell line:ch1', strain:ch1, description.1. 
...
```{r dnam-subset}
bcidx <- match(targets$barcode,colnames(dt))
dpidx <- bcidx  + 1
